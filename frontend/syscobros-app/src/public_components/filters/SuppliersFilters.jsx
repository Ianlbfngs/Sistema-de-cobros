...
function SuppliersFilters({ filters, handleFilterChange, setFilters }) {
            ...
            {showFilters && (
                <div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div>
                            <label className="table-filter-label">Id del proveedor</label>
                            <input name="id" value={filters.id} onChange={handleFilterChange} className="table-filter-input" />
                        </div>

                        <div>
                            <label className="table-filter-label">Razon Social</label>
                            <input name="name" value={filters.name} onChange={handleFilterChange} className="table-filter-input" />
                        </div>

                        <div>
                            <label className="table-filter-label">CUIT</label>
                            <input name="cuit" value={filters.cuit} onChange={handleFilterChange} className="table-filter-input" />
                        </div>
